...
public class ClinicServiceImpl implements ClinicService {
    ...
    @Override
    @Transactional(readOnly = true)
    public Page<Owner> findOwnersByCriteria(String lastName, Pageable pageable) throws DataAccessException {
        if (lastName != null) {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<Owner> findOwnersByCriteria(String lastName, String city) {
